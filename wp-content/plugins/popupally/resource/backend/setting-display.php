<div class="wrap">
	...
	<div class="popupally-display-sidebar">
		...
		<?php }
		if ($to_hide !== 2) { ?>
		<a class="popupally-display-sidebar-4" target="_blank" href="http://ambitionally.com/webinarally/?utm_source=freeplugin&utm_medium=banner&utm_content=sidebar&utm_campaign=webinarally">
			<img src="<?php echo $plugin_dir; ?>/resource/backend/popupally-side4.jpg" alt="Get WebinarAlly!" width="300" height="350">
		</a>
		<?php } ?>

...
<div class="popupally-sub-setting-content-container" popupally-responsive-tab-group-{{id}}-plsbvs="0">
	...
	<div class="popupally-setting-section follow-scroll step-aside" popup-id="{{id}}" template-id="plsbvs" level="0" margin-before="#plsbvs-customization-section-{{id}}">
...
<div style="display:none;" class="popupally-sub-setting-content-container" popupally-responsive-tab-group-{{id}}-plsbvs="1">
	<div style="height:1px;"></div>
	<div class="popupally-setting-section follow-scroll step-aside" popup-id="{{id}}" template-id="plsbvs" level="1" margin-before="#plsbvs-customization-960-section-{{id}}">
...
<div style="display:none;" class="popupally-sub-setting-content-container" popupally-responsive-tab-group-{{id}}-plsbvs="2">
	<div style="height:1px;"></div>
	<div class="popupally-setting-section follow-scroll step-aside" popup-id="{{id}}" template-id="plsbvs" level="1" margin-before="#plsbvs-customization-640-section-{{id}}">

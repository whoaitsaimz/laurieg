...
<div class="popupally-sub-setting-content-container" popupally-responsive-tab-group-{{id}}-bxsjbi="0">
	...
	<div class="popupally-setting-section follow-scroll step-aside" popup-id="{{id}}" template-id="bxsjbi" level="0" margin-before="#customization-section-{{id}}">
...
<div style="display:none;" class="popupally-sub-setting-content-container" popupally-responsive-tab-group-{{id}}-bxsjbi="1">
	<div style="height:1px;"></div>
	<div class="popupally-setting-section follow-scroll step-aside" popup-id="{{id}}" template-id="bxsjbi" level="1" margin-before="#bxsjbi-customization-960-section-{{id}}">
...
<div style="display:none;" class="popupally-sub-setting-content-container" popupally-responsive-tab-group-{{id}}-bxsjbi="2">
	<div style="height:1px;"></div>
	<div class="popupally-setting-section follow-scroll step-aside" popup-id="{{id}}" template-id="bxsjbi" level="1" margin-before="#bxsjbi-customization-640-section-{{id}}">

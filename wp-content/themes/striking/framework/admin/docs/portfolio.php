...
<strong>Display Title</strong>, <strong>Display Description</strong>,  <strong>Display More Button</strong>,  <strong>More Button Text</strong>.	
</p>
...
<ol>
	...
	<li>
		<p>Then configure the portfolio item options. You can go to <a href="<?php echo get_option('siteurl'); ?>/wp-admin/admin.php?page=theme_portfolio">Strinking->Portfolio</a> to change the set with in <strong>Single Portfolio Item</strong> module.</p>

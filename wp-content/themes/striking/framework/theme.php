...
class Theme {
	...
	function supports() {
		if (function_exists('add_theme_support')) {
			...
			*/
			...
			add_theme_support('post-thumbnails', array('post', 'page', 'portfolio', 'slideshow', 'press'));
	...
	function widgets() {
		...
		require_once (THEME_WIDGETS . '/recentpress.php');
		...
		register_widget('Theme_Widget_Recent_Press');

...
class Theme_Widget_Contact_Form extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('id'=>'Theme_Widget_Contact_Form','classname' => 'widget_contact_form', 'description' => __( 'Displays an email contact form.', 'striking_admin') );
		parent::__construct('contact_form', THEME_SLUG.' - '.__('Contact Form', 'striking_admin'), $widget_ops);
